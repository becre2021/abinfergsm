    ...
    for ith_comparison_spt in comparison_variable_sptnum_list:
        ...
        for jth_rep in range(setting_dict['num_rep']):
            ...
            if args.filename in ['Concrete']:
                ...
                if args.filename in ['parkinsons','kin8nm']:
                    ...
                    # https://drive.google.com/file/d/0BxWe_IuTnMFcYXhxdUNwRHBKTlU/edit 
                    x_train, x_val, x_test, y_train, y_val,y_test = _load_ucidataset_wilson(args.filename, split= .2 ,fold=jth_rep)
